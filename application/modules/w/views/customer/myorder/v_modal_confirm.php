 									<div class="modal-dialog">
                                        ...
                                        <form id="formmodal" action="<?php echo base_url(FOMODULE.'/customer/save_cancel#statepay')?>">
                                        ...
                                        <input type="hidden" name="id_order" value="<?php echo $id_order?>">
                                         	<div class="modal-body">                                        		
                                         		<div class="no-content-comment" style="text-align:center">
						                            ...
						                            <h4><?php echo lang('surecancel')?></h4>
						                            <div class="sm-margin"></div>
						                            <p><span style="color:#7c807e"><?php echo lang('payback')?></span></p>						                          
						                        </div>
                                         	</div>                                  
