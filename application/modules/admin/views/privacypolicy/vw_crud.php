		...
		<div class="page-content">				
			<div class="row">
				<div class="col-xs-12">
					...
					<input type="hidden" name="id_privacy_policy" value="<?php echo isset($id_privacy_policy) ? $id_privacy_policy : ''?>">
							   ...
							   <?php $this->load->view('vw_button_form')?>																
								<div class="widget-body">
									<div class="widget-main padding-6 no-padding-left no-padding-right">
										...
										<div class="form-group required">
											<label class="col-sm-4 control-label"> Privacy Name </label>
											<div class="col-sm-5">
												<input type="text" placeholder="Privacy Name"  name="name" class="col-xs-10 col-sm-10" value="<?php echo isset($name) ? $name : ''?>" required/>
											</div>
										</div>											
