			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form class="form-horizontal" id="form-ajax" value="<?php echo base_url(MODULE.'/'.$class.'/proses')?>">								
						<input type="hidden" name="code_departement" value="<?php echo $code_departement?>">		
									...
									<table class="table table-striped table-bordered table-hover">
										<thead>
											<tr><th>#</th>									
												...
												<th class="center">
													<label>
														<?php 
														$total = $this->m_admin->total_modul(array('code_departement'=>$code_departement,'active'=>1));
														$checked = ($count == $total) ? 'checked' : '';
														?>
														<input type="checkbox" class="ace ace ace-checkbox-2" <?php echo $checked?> id="active-all" value="<?php echo $code_departement.'#active'?>" onclick="ajaxcheck('<?php echo base_url(MODULE.'/'.$class.'/check_permission/1')?>',this.value,this)"/>
												...
												<th class="center">
													<label>
													<?php 
														$total = $this->m_admin->total_modul(array('code_departement'=>$code_departement,'view'=>1));
														$checked = ($count == $total) ? 'checked' : '';
														?>
														<input type="checkbox" class="ace ace ace-checkbox-2" <?php echo $checked?> id="view-all" value="<?php echo $code_departement.'#view'?>" onclick="ajaxcheck('<?php echo base_url(MODULE.'/'.$class.'/check_permission/1')?>',this.value,this)"/>
												...
												<th class="center">
													<label>
													<?php 
														$total = $this->m_admin->total_modul(array('code_departement'=>$code_departement,'add'=>1));
														$checked = ($count == $total) ? 'checked' : '';
														?>
														<input type="checkbox" class="ace ace ace-checkbox-2" <?php echo $checked?> id="add-all" value="<?php echo $code_departement.'#add'?>" onclick="ajaxcheck('<?php echo base_url(MODULE.'/'.$class.'/check_permission/1')?>',this.value,this)"/>
												...
												<th class="center">
													<label>
													<?php 
														$total = $this->m_admin->total_modul(array('code_departement'=>$code_departement,'edit'=>1));
														$checked = ($count == $total) ? 'checked' : '';
														?>
														<input type="checkbox" class="ace ace ace-checkbox-2" <?php echo $checked?> id="edit-all" value="<?php echo $code_departement.'#edit'?>" onclick="ajaxcheck('<?php echo base_url(MODULE.'/'.$class.'/check_permission/1')?>',this.value,this)"/>
												...
												<th class="center">
													<label>
													<?php 
														$total = $this->m_admin->total_modul(array('code_departement'=>$code_departement,'delete'=>1));
														$checked = ($count == $total) ? 'checked' : '';
														?>
														<input type="checkbox" class="ace ace ace-checkbox-2" <?php echo $checked?> id="delete-all" value="<?php echo $code_departement.'#delete'?>" onclick="ajaxcheck('<?php echo base_url(MODULE.'/'.$class.'/check_permission/1')?>',this.value,this)"/>
										...
										<tbody>
											...
											foreach ($modul_parent as $row){
												...
												$where = array('A.id_modul_parent'=>$row->id_modul,'B.code_departement'=>$code_departement);
												...
												foreach ($sub_modul as $val){	
													...
													echo '<tr><td></td>
															...
															<td><a data-toggle="modal" class="btn btn-info btn-mini" title="Access Function" href="#myModal" data-rel="tooltip" onclick="modalShow(\''.base_url('superadmin/admprofile/access_function').'\',\''.$code_departement.'#'.$val->id_modul.'\',\'myModal\')">
