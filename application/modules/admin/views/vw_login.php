						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="white" id="id-text2"><?php echo $this->config->config['title2']?></span>
								</h1>
								<h4 class="blue" id="id-company-text">&copy; <?php echo $this->session->userdata('company_name')?></h4>
							</div>
