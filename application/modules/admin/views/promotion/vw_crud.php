		...
		<div class="page-content">				
			<div class="row">
				<div class="col-xs-12">
					...
					<input type="hidden" name="id_promotion" value="<?php echo isset($id_promotion) ? $id_promotion : ''?>">
							   ...
							   <?php $this->load->view('vw_button_form')?>																
								<div class="widget-body">									
									<div class="widget-main padding-6 no-padding-left no-padding-right">
										...
										<div class="form-group required">
											<label class="col-sm-4 control-label"> Title Promo </label>
											<div class="col-sm-5">
												<input type="text" placeholder="Title Promo"  name="title" class="col-xs-10 col-sm-10" value="<?php echo isset($title_promo) ? $title_promo : ''?>" required/>
											</div>
										</div>																
										<div class="form-group">
											<label class="col-sm-4 control-label"> Description </label>
											<div class="col-sm-5">
												<textarea  name="description" class="textareas"><?php echo isset($description) ? $description : ''?></textarea>
											</div>
										</div>
										<div class="form-group required">
