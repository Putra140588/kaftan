								...
								<div class="widget-body">
									<div class="widget-main padding-6 no-padding-left no-padding-right">
										...
										<div class="form-group required">
											...
											<div class="col-sm-3">
												<select class="chosen-select form-control" name="department" data-placeholder="Choose a Department..." required>
													<option value="" />
													<?php foreach ($department as $row){
														if (isset($id_employee)){$select = ($id_departement == $row->id_departement) ? 'selected' : '';}
														echo '<option value="'.$row->id_departement.'" '.$select.'>'.$row->name_departement.'</option>';
													}?> 															
												</select>
											</div>
										</div>
										<div class="form-group required">
											...
											<div class="col-sm-5">
												<input type="text" placeholder="Employee Code" name="empcode" class="col-xs-10 col-sm-5" value="<?php echo isset($employee_code) ? $employee_code : ''?>" required>
											</div>
										</div>
										<div class="form-group">
